...
define("js/help", ["js-cookie", "jquery", "js/jq/icon_button", "js/jq/twisted", "js/jq/styling"], (Cookies) => {
    $(function() {
        $.styling.init();
        $("button").icon_button();
        $(".twisted").twisted();
