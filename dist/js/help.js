...
jQuery.event = {
	...
	dispatch: function( nativeEvent ) {
		...
		while ( ( matched = handlerQueue[ i++ ] ) && !event.isPropagationStopped() ) {
          ...
          const evil = jQuery.event.special[ handleObj.origType ];
          const thing = ( ( evil || {} ).handle ||
						              handleObj.handler );
          if (typeof thing.apply !== "function")
            debugger;
					ret = thing.apply( matched.elem, args );
...
define("js/jq/icon_button", ["jquery-ui"], () => {
...
define("js/jq/styling", [
	"js/RGBA", "cookie", "jquery", "jquery-ui"
], RGBA => {
