...
class Steganographer {
   ...
   */
  constructor({ max_bits = 3, debug = () => {}} = {}) {
    this.maxChunk = max_bits;
    this.debug = debug;
  }
   ...
   * @param {Uint8Array} message the message, in a Uint8Array. Size
   * must be <= (2^32-1)
   * @param {Uint8Array} bytes the image data, 4 bytes per pixel, one byte
