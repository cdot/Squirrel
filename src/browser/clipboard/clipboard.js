...
import { Emitter } from './common/tinyemitter.js';
import { ClipboardActionDefault } from './actions/default.js';
import { ClipboardActionCut } from './actions/cut.js';
import { ClipboardActionCopy } from './actions/copy.js';
...
class Clipboard extends Emitter {
  ...
  constructor(trigger, options) {
    ...
    $(trigger).on('click', (e) => this.onClick(e));
  }
